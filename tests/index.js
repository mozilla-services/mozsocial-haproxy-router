...
describe('MozSoc URL mapping', () => {
  ...
  it('Elk', async () => {
    ...
    assert.equal((await request('@foo/following')).status, 308);
    ...
    assert.equal((await request('search')).status, 308);
