...
describe('MozSoc URL mapping', () => {
  ...
  it('Elk', async () => {
    ...
    assert.equal((await request('@foo/following')).status, 301);
    ...
    assert.equal((await request('search')).status, 301);
  ...
  it('Mastodon deprecated', async () => {
    ...
    assert.equal((await request('about/more')).status, 301);
